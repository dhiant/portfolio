		...
		<header className="bg-sidebar w-full h-28 lg:w-24 lg:h-screen lg:fixed top-0 z-10 flex flex-row lg:flex-col items-center lg:gap-x-10 lg:justify-between relative ">
			...
			<nav className="md:flex flex-row lg:flex-col items-center md:mx-auto gap-x-10 md:gap-x-20 lg:gap-y-10 hidden">
				...
				>
					...
					<RoundToolTip
						toolTipVisibility={
							iconLabel === "home" && toolTipVisibility === "block"
								? "block"
								: "hidden"
						}
						iconLabel="Home"
				...
				>
					...
					<RoundToolTip
						toolTipVisibility={
							iconLabel === "about" && toolTipVisibility === "block"
								? "block"
								: "hidden"
						}
						iconLabel="About me"
				...
				>
					...
					<RoundToolTip
						toolTipVisibility={
							iconLabel === "works" && toolTipVisibility === "block"
								? "block"
								: "hidden"
						}
						iconLabel="My Works"
				...
				>
					...
					<RoundToolTip
						toolTipVisibility={
							iconLabel === "skills" && toolTipVisibility === "block"
								? "block"
								: "hidden"
						}
						iconLabel="My Skills"
				...
				>
					...
					<RoundToolTip
						toolTipVisibility={
							iconLabel === "contact" && toolTipVisibility === "block"
								? "block"
								: "hidden"
						}
						iconLabel="Contact me"
					/>
				</NavLink>
				...
				<NavLink
					...
					onMouseEnter={() => handleToolTipVisibility("feedback", "block")}
					onMouseLeave={() => handleToolTipVisibility("feedback", "hidden")}
				>
					<FontAwesomeIcon
						icon={faComment}
						size="2x"
					...
					<RoundToolTip
						toolTipVisibility={
							iconLabel === "feedback" && toolTipVisibility === "block"
								? "block"
								: "hidden"
						}
						iconLabel="Feedback"
			...
			{/* social links for tablet & desktop mode */}
					...
					<div className="flex flex-col gap-16">
						...
						>
							<FontAwesomeIcon
								...
								className="fill-current hover:text-secondary transition ease-in-out delay-75 hover:-translate-y-1 hover:scale-150 duration-300"
							/>
							<span className="text-4xl text-icon font-coolvetica">
								About Me
							</span>
						</NavLink>
						<NavLink
